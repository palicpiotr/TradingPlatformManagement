...
namespace TradingPlatformManagement.Controllers
{
    public class AccountController : Controller
    {
        ...
        private readonly IPersonTypesProvider _typesProvider;
        ...
        {
            var pts = await _typesProvider.GetPersonTypes();
            ViewBag.PersonTypes = new SelectList(pts, "PersonTypeId", "Name");
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    model.Person.Token = user.Id;
                    await _personProvider.CreatePerson(model.Person);
